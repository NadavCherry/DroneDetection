...
| Versus SOTA (**YOLOMG**, arXiv:2503.07115), *trained by us*, same evaluator | they lead overall on ARD-MAV (0.834 vs 0.809) and NPS (0.527 vs 0.487); **we lead where targets are smallest** — ARD-MAV small-MAV +0.074, our own 8 px task **0.840 vs 0.604** (3-seed means), with **0** distractor false alarms to their 2–13 | 2 benchmarks + 1 task × 3 seeds | 🟢 benchmarks: paired, seed-matched bootstrap + permutation over sequences; the 8 px task: moving-block bootstrap *within* its one held-out flight. The competitor got 2× our gradient steps. [Round 8](docs/reports/round8-sota-campaign.md) |
