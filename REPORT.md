...
Video: `07_05.mp4` — 1280×720 @ 30 fps, 571 readable frames (container metadata claims 741; read sequentially). Camera on a hovering drone; measured drift is sub-pixel per second (max ~1.2 px/s); stabilization applied throughout anyway.
...
.venv/bin/python -m dronedet detect --video 07_05.mp4 --method <name> --out work/det/<name>.json
